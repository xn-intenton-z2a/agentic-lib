...
- [~] Limit the number if attempts to [work++fix] a branch on an issue to 3 (as per agentic-lib.yml), then comment the issue and delete the branch.
- [~] Limit the number if attempts to [work] an issue on an issue to 2 (as per agentic-lib.yml), then comment and close the issue.
