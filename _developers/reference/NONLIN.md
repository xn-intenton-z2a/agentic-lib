...
2. Tate, A. (1977). "Generating Project Networks." *Proceedings of the Fifth International Joint Conference on Artificial Intelligence (IJCAI-77)*, pp. 888–893, Boston, Mass. Reprinted in *Readings in Planning* (Morgan-Kaufmann, 1990).
...
- **Causal links:** Explicitly represents *why* each action is in the plan — what precondition it achieves for what later action. This makes plans intelligible and supports threat detection.
