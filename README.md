...
- **New Feature:** In addition to existing flags, the main script now supports a `--reverse` flag which, when provided, reverses the order of the supplied arguments.
