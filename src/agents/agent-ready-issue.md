...
2. Update the issue description with testable acceptance criteria that validate the delivery of measurable user value. Include ALL of: implementation, tests matching MISSION.md acceptance criteria, website updates, docs/evidence, and README. The issue should ask for maximum output from a single transform.
